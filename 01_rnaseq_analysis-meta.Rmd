...
meta_fileall = meta_fileall[order(meta_fileall$response_mac),]

# id_namedate = subject names _ date 
meta_fileall$id_namedate = paste("uniqueID",
                               as.numeric(factor(as.character(meta_fileall[,id_col]))),
                               as.numeric(factor(as.character(meta_fileall[,date_col]))), sep="_")

# id_name = subject names 
meta_fileall$id_name = paste("ID", as.numeric(factor(as.character(meta_fileall[,id_col]))), sep="_")
...
meta_fileall$calculated_Response[as.character(meta_fileall$response_mac) == "Control"] = "Control"
...
phen = c("black","red","green","grey")[as.numeric(factor(meta_fileall$response_mac))]
...
meta_fileRNASeq = cbind(meta_fileRNASeq0, 
                        mapHiSeqToID[match(meta_fileRNASeq0$Alias, mapHiSeqToID$Alias),!colnames(mapHiSeqToID)%in%colnames(meta_fileRNASeq0)])
