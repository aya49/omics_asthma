...
WhereAmI <- "~/projects/asthma/data/RNAelements/"

## load libraries
library(amritr); library(tidyverse);library(mixOmics)
source(paste0("~/projects/asthma/code/_func-classifiers.R"))
simple_roc <- function(labels, scores){
  labels <- labels[order(scores, decreasing=TRUE)]
  data.frame(TPR=cumsum(labels)/sum(labels), FPR=cumsum(!labels)/sum(!labels), labels)
}

load("~/projects/asthma/data/RNAelements/data/demo_eset_nanoString.RDATA")
```
...
pdf(paste0(WhereAmI, "results/Figure4a.pdf"), width = 15, height = 6.5)
...
## post PC20
demo <- readRDS("~/projects/asthma/data/RNAelements/data/allsitesDemo_clean.rds")
