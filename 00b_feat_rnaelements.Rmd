...
libr(append(pkgs(), c("NormqPCR","mixOmics","amritr")))
```
...
#----------------------------------------------
setName <- paste("Set", 1:length(hba_attenuation_confirmatory_dirs))
date <- rep(c("2016-02-10","2016-02-11"), each = 3)
cartridgeLotNum <- rep("31020635467_exp12.2016", length(hba_attenuation_confirmatory_dirs))
Tag156LotNum <- rep("TS2877-1", length(hba_attenuation_confirmatory_dirs))
ext24TagLotNum <- rep("TS4006", length(hba_attenuation_confirmatory_dirs))
plateLotNum <- rep("41000274-0056_exp02.2016", length(hba_attenuation_confirmatory_dirs))
DatList <- list()
for(h in 1:length(hba_attenuation_confirmatory_dirs)){
  files <- list.files(hba_attenuation_confirmatory_dirs[h], full.names = TRUE)
...
Dat <- do.call(rbind, DatList)
write.csv(Dat, hba_attenuation_confirmatory_dir)
