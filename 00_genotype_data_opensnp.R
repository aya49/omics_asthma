...
opensnp_meta_dir = paste0(genotype_dir, "/opensnp/phenotypes_201805150935.csv")
opensnp_zip_dir = paste0(genotype_dir, "/opensnp/opensnp_datadump.current.zip")

hapmap_call_dir = paste0(genotype_dir, "/hapmap_genotype/Nsp_HapMap270.brlmm.call")
hapmap_conf_dir = paste0(genotype_dir, "/hapmap_genotype/Nsp_HapMap270.brlmm.conf")
hapmap_call0_dir = paste0(genotype_dir, "/hapmap_genotype/Sty_HapMap270.brlmm.call")
hapmap_conf0_dir = paste0(genotype_dir, "/hapmap_genotype/Sty_HapMap270.brlmm.conf")
hapmap_all_dir = paste0(genotype_dir, "/hapmap_genotype/all_CEU.txt")
