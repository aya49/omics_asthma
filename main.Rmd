...
**output**: result/meta/file, result/feat
...
- **result/meta/file.raw (sample x subject + sample meta data)**: same as above except...
...
### meta/col(s) and feat(ures)

- **result/meta/col-\<data\_type\> (feature x feature meta data)**: feature meta data

- **result/feat/\<data_type\>.\<pre/post\> (subject x feature)**: feature matrices with row/colnames coinciding with the 'id' column of meta/file and meta/col
  ...
  - note: since dna does not change, we have only one version
...
i don't know what scale this is in... log something...
