##################################################
#  v8_collect_genotypes_not_in_repeat.R
#
#  /tigress/BEE/RNAseq/Scripts/genotype/gtex/silver/v8_collect_genotypes_not_in_repeat.R
# 
...
file_path = '/tigress/BEE/RNAseq/Data/Genotype/gtex/v8/allelic_dosage/'
...
# for (i in c(c(1:22), 'X')) {
  ...
  save(genotype_mat_not_in_repeat, file = paste0(file_path, 'GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_chr',i,'_dosage_MAF_01_not_in_repeat.RData'))
  ...
  rownames(genotype_mat_not_in_repeat) = genotype_mat_not_in_repeat$X
  genotype_mat_not_in_repeat = genotype_mat_not_in_repeat[,c(2:ncol(genotype_mat_not_in_repeat))]
  save(genotype_mat_not_in_repeat, file = paste0(file_path, 'GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_chr',i,'_dosage_MAF_05_not_in_repeat.RData'))
# }
