##################################################
#  v9_filter_raw_genotypes_dosage.py
#
#  $proj/Scripts/genotype/gtex/silver/v9_filter_raw_genotypes_dosage.py
# 
...
vcf_raw = '/tigress/BEE/gtex/dbGaP-7716/59511/gtex/exchange/GTEx_phs000424/exchange/analysis_releases/GTEx_Analysis_2017-06-05_v8/genotypes/WGS/variant_calls/GTEx_Analysis_2017-06-05_v8_WholeGenomeSeq_838Indiv_Analysis_Freeze.SHAPEIT2_phased.MAF01.vcf.gz'
...
out_dir = '/tigress/BEE/RNAseq/Data/Genotype/gtex/v9/'
current_chr = ''
prev_pos = '0'
prev_id = ''
multiallelic_list = []
