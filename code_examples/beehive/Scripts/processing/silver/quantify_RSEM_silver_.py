...
# With ordered dict, transcripts come in gencode order (but it's not in order for RSEM files)
cur_gene = ''
...
gene_expr_mat_TPM_filter[subject_list_with_geno].to_csv(out_dir + 'genes/' + tissue + '_RSEM_TPM_with_genotype.txt', sep='\t', float_format='%.4f')
gene_expr_mat_counts_filter[subject_list_with_geno].to_csv(out_dir + 'genes/' + tissue + '_RSEM_counts_with_genotype.txt', sep='\t', float_format='%.4f')
isoform_expr_mat_TPM_filter[subject_list_with_geno].to_csv(out_dir + 'isoforms/' + tissue + '_RSEM_TPM_with_genotype.txt', sep='\t', float_format='%.4f')
isoform_expr_mat_counts_filter[subject_list_with_geno].to_csv(out_dir + 'isoforms/' + tissue + '_RSEM_counts_with_genotype.txt', sep='\t', float_format='%.4f')

if len(sample_list_without_geno) > 0:
    gene_expr_mat_TPM_filter[subject_list_without_geno].to_csv(out_dir + 'genes/' + tissue + '_RSEM_TPM_without_genotype.txt', sep='\t', float_format='%.4f')
    gene_expr_mat_counts_filter[subject_list_without_geno].to_csv(out_dir + 'genes/' + tissue + '_RSEM_counts_without_genotype.txt', sep='\t', float_format='%.4f')
    isoform_expr_mat_TPM_filter[subject_list_without_geno].to_csv(out_dir + 'isoforms/' + tissue + '_RSEM_TPM_without_genotype.txt', sep='\t', float_format='%.4f')
    isoform_expr_mat_counts_filter[subject_list_without_geno].to_csv(out_dir + 'isoforms/' + tissue + '_RSEM_counts_without_genotype.txt', sep='\t', float_format='%.4f')
