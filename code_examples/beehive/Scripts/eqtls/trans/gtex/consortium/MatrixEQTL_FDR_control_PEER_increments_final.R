...
#
#  $proj/Scripts/eqtls/trans/gtex/consortium/MatrixEQTL_FDR_control_PEER_increments_final.R
# 
...
save(cumulative_me_trans_total, cumulative_me_trans_prot_only, cumulative_me_trans_linc_only, all_hist_vals_trans_total, all_n_tests_trans_total, all_n_tests_prot_total, all_n_tests_linc_total, snp_set_size_final_total, file=paste(write_dir, 'eqtl_list/', tissue_name, '_', nPEER, "_trans_list_by_pvalue.RData", sep=""))
