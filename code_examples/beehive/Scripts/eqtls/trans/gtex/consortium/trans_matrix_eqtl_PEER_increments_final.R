##################################################
#  trans_matrix_eqtl_PEER_increments_final.R
#
#  $proj/Scripts/eqtls/trans/gtex/consortium/trans_matrix_eqtl_PEER_increments_final.R
# 
#  This version performs the all-by-all trans-mapping analysis but with PEER factors in increments of 5.
#
#  Author: Brian Jo
#
##################################################
