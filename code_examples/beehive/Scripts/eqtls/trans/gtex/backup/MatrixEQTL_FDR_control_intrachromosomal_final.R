...
#
#  $proj/Scripts/eqtls/trans/gtex/MatrixEQTL_FDR_control_intrachromosomal_final.R
# 
...
save(cumulative_me_trans_total, cumulative_me_cis_total, file=paste(write_dir, 'eqtl_list/', tissue_name, "_intrachrom_list_by_pvalue.RData", sep=""))
