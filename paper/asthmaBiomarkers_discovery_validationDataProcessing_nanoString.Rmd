...
load("~/projects/asthma/data/RNAseq_nanostring/results/biomarkerCandidateSelection/rnaseq_to_nanoString_biomarkers.RDATA")

source("~/projects/asthma/data/RNAseq_nanostring/src/functions.R")
#----------------------------------------------
# 1) HBA attenutation (Discovery cohort)
#----------------------------------------------
filePaths <- c("~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_rediscovery/20160114_test0 max fovjan14-2016 _RCC",
               "~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_rediscovery/20160116_set2 jan 16-2016 max fov_RCC",
               "~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_rediscovery/20160116_set 3 3-1 to 3-12 jan16 2016 max fov_RCC",
               "~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_rediscovery/20160116_set 4 4-1 to 4-12 maxfov jan 16-2016_RCC")
...
write.csv(Dat, "~/projects/asthma/data/RNAseq_nanostring/data/HBA2Attenutation_asthmaBiomarkersDiscovery.csv")

#------------
# import data 
#------------
sampleMap0 <- read.csv("~/projects/asthma/data/RNAseq_nanostring/validation/reCalibration/attenuation/AttenuationnanoElementsDemo_labSheet.csv")
...
data <- read.csv("~/projects/asthma/data/RNAseq_nanostring/reAnalysis/data/HBA2Attenutation_asthmaBiomarkersDiscovery.csv", row.names = 1)
...
#----------------------------------------------
filePaths <- c("~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_replication/20160210_asthma biomarkersvalidation set1 v1-v12 maxFOV Feb-10-2016_RCC",
               "~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_replication/20160210_asthma biomarkersvalidation set2 v13-v24 maxFOV Feb-10-2016_RCC",
               "~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_replication/20160210_asthma biomarkersvalidation set3 v25-v36 maxFOV Feb-10-2016_RCC",
               "~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_replication/20160211_asthma biomarkersvalidation set4 v37-v48 maxFOV Feb-11-2016_RCC",
               "~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_replication/20160211_asthma biomarkersvalidation set5 v49-v60 maxFOV Feb-11-2016_RCC",
               "~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_replication/20160211_asthma biomarkersvalidation set6 v61-v72 maxFOV Feb-11-2016_RCC")
setName <- paste("Set", 1:length(filePaths))
...
Dat <- do.call(rbind, DatList)
write.csv(Dat, "~/projects/asthma/data/RNAseq_nanostring/reAnalysis/data/HBA2Attenutation_asthmaBiomarkersValidation.csv")

#------------
# import data 
#------------
mappingFile <- read.csv("~/projects/asthma/data/RNAseq_nanostring/data/validation/HBA2_attenuation_replication/validationCohort_mappngFile.csv", row.names = 7)
data <- read.csv("~/projects/asthma/data/RNAseq_nanostring/reAnalysis/data/HBA2Attenutation_asthmaBiomarkersValidation.csv", row.names = 1)
...
```{r}
demo0 <- readRDS("~/projects/asthma/data/RNAseq_nanostring/reAnalysis/data/allsitesDemo_clean.rds")
...
save(demo1_dis=demo1_dis, demo1_val=demo1_val, y.train=y.train, y.test=y.test,
  ...
  file = "~/projects/asthma/data/RNAseq_nanostring/reAnalysis/data/demo_eset_nanoString.RDATA")
