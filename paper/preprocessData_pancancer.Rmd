...
## 2b. Binding Density
  * the Digital analyzer does not count srcs that overlap
  * if too many srcs overlap, there can be significant data loss
  * Binding densitiy (image saturation) = measure of the # of optical features per square micron
  * binding density > 2: significant numbers of srcs ignored, affects quantification and linearity of the assay
...
group[group != "L_ST_026"] <- "results/enrichr samples"
