...
## load libraries
library(amritr); library(tidyverse);library(mixOmics)
...
load("~/Dropbox/Asthma/biomarkerPanels/reAnalysis/data/demo_eset_nanoString.RDATA")
```
...
pdf(paste0(WhereAmI, "results/Figures/Figure4/Figure4a.pdf"), width = 15, height = 6.5)
...
11/24 # female (dr)
5/9 # female (er)
table(droplevels(demo1_val$Allergen_cleanLabel), demo1_val$calculated_Response)
...
## post PC20
demo <- readRDS("~/Dropbox/Asthma/biomarkerPanels/reAnalysis/data/allsitesDemo_clean.rds")
...
pdf(paste0(WhereAmI, "results/Figures/Figure4/Figure4b_revised.pdf"), width = 15, height = 6.5)
...
pdf(paste0(WhereAmI, "results/Figures/Figure5/Figure5a.pdf"), width = 5, height = 4)
...
dev.off()
pdf(paste0(WhereAmI, "results/Figures/Figure5/Figure5b.pdf"), width = 6, height = 4)
...
NMF::aheatmap(t(scaledX), annCol = list(Response = Y),
  ...
  filename = paste0(WhereAmI, "results/Figures/Figure5/Figure5c.pdf"), width = 12, height = 6)
...
```{r}
pdf(paste0(WhereAmI, "results/Figures/Figure5/Figure5d.pdf"), width = 12, height = 8)
