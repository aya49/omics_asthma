---
title: "asthmaBiomarkers_discoveryDataAnalysis_rnaSeq"
author: "Amrit Singh"
date: '2017-08-07'
output:
  pdf_document:
...
source(paste0(WhereAmI, "src/functions_classifiers.R"))

## load datasets (demographics and rnaseq data)
load(paste0(WhereAmI, "data/rnaseqDatasets.RDATA"))
...
```{r}
rnaseq_demo_pre <- subset(rnaseq_demo, Time == "Pre")
rnaseq_datasets_pre <- lapply(rnaseq_datasets, function(i){
  i[, rownames(rnaseq_demo_pre)]
})

cc_pre <- rnaseq_demo_pre %>% 
...
## Leukocytes
fit <- lm(rnaseq_demo_pre$Leukocyte_Counts.x10.9. ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) # normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.31
## Neutrophils
fit <- lm(rnaseq_demo_pre$Neu_percent ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) # normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.19
## Lymphocytes
fit <- lm(rnaseq_demo_pre$lym_percent ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) # normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.70
## Monocytes
fit <- lm(rnaseq_demo_pre$mono_percent ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) # normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.24
## Eosinophils
fit <- lm(rnaseq_demo_pre$eos_percent ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals)  # NOT normal!
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = rnaseq_demo_pre$eos_percent[rnaseq_demo_pre$calculated_Response == "ER"], 
            y = rnaseq_demo_pre$eos_percent[rnaseq_demo_pre$calculated_Response == "DR"])  # pw=0.27
## Basophils
fit <- lm(rnaseq_demo_pre$baso_percent ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals)  # NOT normal!
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = rnaseq_demo_pre$baso_percent[rnaseq_demo_pre$calculated_Response == "ER"], 
            y = rnaseq_demo_pre$baso_percent[rnaseq_demo_pre$calculated_Response == "DR"])  # pw=0.36

# variables that are normally distributed
rnaseq_demo_pre %>% dplyr::select(Leukocyte_Counts.x10.9., Neu_percent, lym_percent, mono_percent, calculated_Response) %>% 
...
rnaseq_demo_pre %>% dplyr::select(eos_percent, baso_percent, calculated_Response) %>% 
  gather(Cells, Value, -calculated_Response) %>% 
  group_by(Cells, calculated_Response) %>% 
...
## summarize demographics of discovery cohort

```{r}
table(rnaseq_demo_pre$calculated_Response)
table(rnaseq_demo_pre$SEX, rnaseq_demo_pre$calculated_Response)
13/19 # proporiton of female (ER)
11/17 # proporiton of female (DR)
table(droplevels(rnaseq_demo_pre$Allergen_cleanLabel), rnaseq_demo_pre$calculated_Response)
table(droplevels(rnaseq_demo_pre$SITE), rnaseq_demo_pre$calculated_Response)

## Weight
fit <- lm(rnaseq_demo_pre$Wt..Kg. ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## not normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = rnaseq_demo_pre$Wt..Kg.[rnaseq_demo_pre$calculated_Response == "ER"], 
            y = rnaseq_demo_pre$Wt..Kg.[rnaseq_demo_pre$calculated_Response == "DR"])  # pw=0.23
## height
fit <- lm(rnaseq_demo_pre$HT.cm. ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) #pt = 0.91
## Age
fit <- lm(rnaseq_demo_pre$AGE ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## not normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = rnaseq_demo_pre$AGE[rnaseq_demo_pre$calculated_Response == "ER"], 
            y = rnaseq_demo_pre$AGE[rnaseq_demo_pre$calculated_Response == "DR"])  # pw=0.65
## BLFEV 
fit <- lm(rnaseq_demo_pre$BLFEV ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) #pt = 0.95
## PRFEV
fit <- lm(rnaseq_demo_pre$PRFEV ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## not normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = rnaseq_demo_pre$PRFEV[rnaseq_demo_pre$calculated_Response == "ER"], 
            y = rnaseq_demo_pre$PRFEV[rnaseq_demo_pre$calculated_Response == "DR"])  # pw=0.91
## EAR 
fit <- lm(rnaseq_demo_pre$EAR ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## not normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = rnaseq_demo_pre$EAR[rnaseq_demo_pre$calculated_Response == "ER"], 
            y = rnaseq_demo_pre$EAR[rnaseq_demo_pre$calculated_Response == "DR"])  # pw=0.12
## LAR 
fit <- lm(rnaseq_demo_pre$LAR ~ rnaseq_demo_pre$calculated_Response) 
plot(fit)
shapiro.test(fit$residuals) ## normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=2.86e-14
## PC20
fit <- lm(rnaseq_demo_pre$PC20 ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## not normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = rnaseq_demo_pre$PC20[rnaseq_demo_pre$calculated_Response == "ER"], 
            y = rnaseq_demo_pre$PC20[rnaseq_demo_pre$calculated_Response == "DR"])  # pw=0.11
## AIS
fit <- lm(rnaseq_demo_pre$AIS ~ rnaseq_demo_pre$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt = 0.01
...
# variables that are NOT normally distributed
rnaseq_demo_pre %>% dplyr::select(Wt..Kg.,AGE,PRFEV, EAR, PC20, calculated_Response) %>% 
  gather(Cells, Value, -calculated_Response) %>% 
  group_by(Cells, calculated_Response) %>% 
  dplyr::summarise(Median = round(median(Value, na.rm = TRUE), 2), 
    Q1 = quantile(Value, 0.25, na.rm = TRUE), Q3 = quantile(Value, 0.75, na.rm = TRUE))
...
# variables that are normally distributed
rnaseq_demo_pre %>% dplyr::select(HT.cm., BLFEV, LAR, AIS, calculated_Response) %>% 
...
```{r}
design <- model.matrix(~factor(rnaseq_demo_pre$calculated_Response, levels = c("ER", "DR")))
nrow(rnaseq_demo_pre); table(rnaseq_demo_pre$calculated_Response)
deg_pre <- lapply(1 : length(rnaseq_datasets_pre), function(i){
  fit <- eBayes(lmFit(rnaseq_datasets_pre[[i]], design))
...
gp <- factor(rnaseq_demo_pre$calculated_Response, levels = c("ER", "DR"))
design <- model.matrix(~gp+Leukocyte_Counts.x10.9., data = rnaseq_demo_pre)
nrow(rnaseq_demo_pre[rownames(design), ]); table(rnaseq_demo_pre[rownames(design), "calculated_Response"])
deg_pre_cc <- lapply(1 : length(rnaseq_datasets_pre), function(i){
  fit <- eBayes(lmFit(rnaseq_datasets_pre[[i]][, rownames(design)], design))
  top <- topTable(fit, coef = 2, adjust.method = "BH", n = nrow(fit))
  top$NumOfGenes <- 1:nrow(top)
  top$Dataset <- rep(names(rnaseq_datasets_pre)[i], nrow(top))
  top$Comparison <- "Pre"
...
## Post-challenge
rnaseq_demo_post <- subset(rnaseq_demo, Time == "Post")
rnaseq_datasets_post <- lapply(rnaseq_datasets, function(i){
  i[, rownames(rnaseq_demo_post)]
})
...
design <- model.matrix(~factor(rnaseq_demo_post$calculated_Response, levels = c("ER", "DR")))

deg_diff <- lapply(1 : length(rnaseq_datasets_diff), function(i){
  fit <- eBayes(lmFit(rnaseq_datasets_diff[[i]], design))
  top <- topTable(fit, coef = 2, adjust.method = "BH", n = nrow(fit))
  top$NumOfGenes <- 1:nrow(top)
...
## adjust for cell-types
diff_cc <- rnaseq_demo_post[, "Leukocyte_Counts.x10.9."] - rnaseq_demo_pre[, "Leukocyte_Counts.x10.9."]
designDat <- data.frame(response = rnaseq_demo_post$calculated_Response,
           cc = diff_cc)
rownames(designDat) <- rownames(rnaseq_demo_post)
nrow(rnaseq_demo_post[rownames(na.omit(designDat)),]); table(rnaseq_demo_post[rownames(na.omit(designDat)), "calculated_Response"])
design <- model.matrix(~response+cc, data = designDat)
table(design[,"responseER"])

deg_diff_cc <- lapply(1 : length(rnaseq_datasets_diff), function(i){
  fit <- eBayes(lmFit(rnaseq_datasets_diff[[i]][, rownames(design)], design))
  top <- topTable(fit, coef = 2, adjust.method = "BH", n = nrow(fit))
  top$NumOfGenes <- 1:nrow(top)
  top$Dataset <- rep(names(rnaseq_datasets_diff)[i], nrow(top))
  top$Comparison <- "Interaction"
...
## demographics (PC20 post)
fit <- lm(rnaseq_demo_post$PC20 ~ rnaseq_demo_post$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) ## not normal
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = rnaseq_demo_post$PC20[rnaseq_demo_post$calculated_Response == "ER"], 
            y = rnaseq_demo_post$PC20[rnaseq_demo_post$calculated_Response == "DR"])  # pw=0.11

# variables that are NOT normally distributed
rnaseq_demo_post %>% dplyr::select(PC20, calculated_Response) %>% 
  gather(Cells, Value, -calculated_Response) %>% 
  group_by(Cells, calculated_Response) %>% 
  dplyr::summarise(Median = round(median(Value, na.rm = TRUE), 2), 
    Q1 = quantile(Value, 0.25, na.rm = TRUE), Q3 = quantile(Value, 0.75, na.rm = TRUE))
...
## Cell-types
cbc_diff <- rnaseq_demo_post[, c("Leukocyte_Counts.x10.9.", "Neu_percent", 
                              "lym_percent", "mono_percent", "eos_percent", "baso_percent")] - rnaseq_demo_pre[, c("Leukocyte_Counts.x10.9.", "Neu_percent", 
                              "lym_percent", "mono_percent", "eos_percent", "baso_percent")]

cc_diff <- cbc_diff %>% 
    mutate(Response = factor(rnaseq_demo_pre$calculated_Response, levels = c("ER", "DR"))) %>% 
  dplyr::select(Response, Leukocyte_Counts.x10.9., Neu_percent, 
                              lym_percent, mono_percent, eos_percent, baso_percent) %>% 
  gather(Cells, freq, -Response)
...
## which cell frequencies signficantly changes between er and dr at pre-challenge
## Leukocytes
fit <- lm(cbc_diff$Leukocyte_Counts.x10.9. ~ rnaseq_demo_post$calculated_Response)
plot(fit)
shapiro.test(fit$residuals)
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.57
## Neutrophils
fit <- lm(cbc_diff$Neu_percent ~ rnaseq_demo_post$calculated_Response)
plot(fit)
shapiro.test(fit$residuals)
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.85
## Lymphocytes
fit <- lm(cbc_diff$lym_percent ~ rnaseq_demo_post$calculated_Response)
plot(fit)
shapiro.test(fit$residuals)
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.80
## Monocytes
fit <- lm(cbc_diff$mono_percent ~ rnaseq_demo_post$calculated_Response)
plot(fit)
shapiro.test(fit$residuals)
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.65
## Eosinophils
fit <- lm(cbc_diff$eos_percent ~ rnaseq_demo_post$calculated_Response)
plot(fit)
shapiro.test(fit$residuals)  # NOT normal!
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
wilcox.test(x = cbc_diff$eos_percent[rnaseq_demo_post$calculated_Response == "ER"], 
            y = cbc_diff$eos_percent[rnaseq_demo_post$calculated_Response == "DR"])  # pw=0.33
## Basophils
fit <- lm(cbc_diff$baso_percent ~ rnaseq_demo_post$calculated_Response)
plot(fit)
shapiro.test(fit$residuals) 
qqnorm(fit$residuals); qqline(fit$residuals, col = 2)
summary(fit) # Pt=0.22
...
pdf(paste0(WhereAmI, "results/Figures/Figure2/Figure2a.pdf"), width = 15, height = 5)
...
## overlap between mrna transcripts

```{r}
sapply(deg_pre, function(i){
  sum(i$adj.P.Val < 0.15)
})
sapply(deg_pre_cc, function(i){
  sum(i$adj.P.Val < 0.15)
})
...
lapply(deg_pre_cc_common, function(i){
  c(sum(i$t > 0), sum(i$t <0))
})
...
pdf(paste0(WhereAmI, "results/Figures/Figure2/Figure2b.pdf"), width = 15, height = 5)
...
mapID_genSym <- mapply(function(x, y){
  annotateTranscripts(features=rownames(x), filter = y, mart=mart)
}, x = deg_pre_cc_common, y = list("ucsc", "ucsc", "ensembl_gene_id", "trinity"))
sigGenes <- unique(unlist(mapID_genSym))
length(sigGenes);
write.csv(sigGenes, paste0(WhereAmI, "results/diff_Exp/significantgenes_DEanalysis.csv"))
...
```{r}
library(sear); library(RColorBrewer)
input <- sear(input=sigGenes, type = 'mrna') %>%
  filter(collection %in% c("TISSUES")) %>% 
  arrange(fdr)
input$geneset <- as.character(input$geneset)
input$geneset[input$subcollection == "CNS"] <- "CNS"
input$geneset <- factor(input$geneset)
input <- input %>% dplyr::group_by(subcollection, geneset) %>% dplyr::summarise(fdr = mean(fdr))
input$subcollection <- factor(input$subcollection, 
                        levels = toupper(c("cns", "thymus", "tonsils", "spleen", "lymph", 
                                   "bcells","myeloid", "nkcells","blood","rbcs","neutrophils",
                                   "tcells","th1cells","th2cells","tregs","cd8tcells","cd4tcells")))
subCol <- input %>% dplyr::group_by(subcollection) %>% 
...
cbPalette <- c("#999999", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7",
               brewer.pal(9, "Set1"))
pdf(paste0(WhereAmI, "results/Figures/Figure2/Figure2c.pdf"), width = 8, height = 5.5)
...
```{r}
biocartaPathways <- read.delim(paste0(WhereAmI, "results/diff_Exp/BioCarta_2016_table.txt"))
biocartaPathways <- subset(biocartaPathways, Adjusted.P.value < 0.15)
keggPathways <- read.delim(paste0(WhereAmI, "results/diff_Exp/KEGG_2016_table.txt"))
keggPathways <- subset(keggPathways, Adjusted.P.value < 0.15)
wikiPathways <- read.delim(paste0(WhereAmI, "results/diff_Exp/WikiPathways_2016_table.txt"))
...
pdf(paste0(WhereAmI, "results/Figures/Figure2/Figure2d.pdf"), width = 10, height = 10)
...
folds.iter <- lapply(readRDS(paste0(WhereAmI, "data/prePerfNoCov.rds")), function(i) i$folds.iter) 
response <- factor(rnaseq_demo_pre$calculated_Response, levels = c("ER", "DR"))
names(response) <- rownames(rnaseq_demo_pre)
...
#delta
#saveRDS(cv, paste0(WhereAmI, "results/rnaseq_biomarkerPanelPerformanceResults.rds"))

cv <- readRDS(paste0(WhereAmI, "results/rnaseq_biomarkerPanelPerformanceResults.rds"))
...
cc_pre <- na.omit(rnaseq_demo_pre[, c("BLFEV", "PC20", "Leukocyte_Counts.x10.9.","Neu_percent","lym_percent","mono_percent","eos_percent","baso_percent")])
...
aucDats <- AUC %>% zip_nPure() %>% lapply(., function(i) do.call(rbind, i)) %>% 
  ...
  gather(Classifier, value, -Dataset) %>% 
  dplyr::group_by(Dataset, Classifier) %>% 
  dplyr::summarise(MeanAUC = mean(value), sdAUC = sd(value))
...
pdf(paste0(WhereAmI, "results/Figures/Figure3/Figure3a.pdf"), width = 6, height = 4)
...
#saveRDS(FreqPanels, paste0(WhereAmI, "results/biomarkerCandidateSelection.rds"))

FreqPanels <- readRDS(paste0(WhereAmI, "results/biomarkerCandidateSelection.rds"))
...
grid.newpage();
pdf(paste0(WhereAmI, "results/Figures/Figure3/Figure3b.pdf"), width = 5, height = 5)
grid.draw(venn.plot);
dev.off()
...
```{r}
all(colnames(rnaseqBiomarkers) == rownames(rnaseq_demo))
rnaseqBiomarkers_pre <- rnaseqBiomarkers[, rnaseq_demo$Time == "Pre"]
design <- model.matrix(~factor(rnaseq_demo_pre$calculated_Response, c("ER", "DR")))
fit <- eBayes(lmFit(rnaseqBiomarkers_pre, design))
...
pdf(paste0(WhereAmI, "results/Figures/Figure3/Figure3c.pdf"), width = 6, height = 4)
...
```{r}
response <- factor(rnaseq_demo_pre$calculated_Response, levels = c("ER", "DR"))
names(response) <- gsub(".Pre", "", rownames(rnaseq_demo_pre))
...
pdf(paste0(WhereAmI, "results/Figures/Figure3/Figure3d.pdf"), width = 6, height = 4)
...
```{r}
rnaseqBiomarkers_post <- rnaseqBiomarkers[, rnaseq_demo$Time == "Post"]
all(rnaseq_demo[colnames(rnaseqBiomarkers_post), "NAME"] == rnaseq_demo[colnames(rnaseqBiomarkers_pre), "NAME"])
rnaseqBiomarkers_diff <- rnaseqBiomarkers_post - rnaseqBiomarkers_pre
design <- model.matrix(~factor(rnaseq_demo_pre$calculated_Response, c("ER", "DR")))
fit_int <- eBayes(lmFit(rnaseqBiomarkers_diff, design))
...
save(ucscGenes_candidates = ucscGenes_candidates, 
  ...
  file = paste0(WhereAmI, "results/biomarkerCandidateSelection/rnaseq_to_nanoString_biomarkers.RDATA"))
