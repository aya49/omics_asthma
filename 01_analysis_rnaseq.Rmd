...
```{r}
biocartaPathways <- read.delim(rnaseq_difbc_dir)
biocartaPathways <- subset(biocartaPathways, Adjusted.P.value < 0.15)
keggPathways <- read.delim(rnaseq_difkegg_dir)
keggPathways <- subset(keggPathways, Adjusted.P.value < 0.15)
wikiPathways <- read.delim(rnapc_erwiki_dir)
