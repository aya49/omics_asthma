...
# commandArgs <- function(...) root  # root directory
# source(paste0(root, "/code/_prep.R"))


## root directory
root = ifelse (dir.exists(commandArgs()), commandArgs(), "~/projects/asthma")
...
gt1_call_dir = paste0(genotype_dir, "/AxiomGT1.calls.txt") # data
meta_snp_temp_dir = paste0(genotype_dir, "/Axiom_PMRA.na35.annot.csv") # feature snp annotations
meta_snp_idrod_dir = paste0(genotype_dir, "/rod/rod.csv")

# transcriptomics rnapancancer
...
rnapc_pairs_dir = paste0(rnapc_dir, "/results/Figures/Fig.S1.pdf")
...
rnapc_erhga_dir = paste0(rnapc_dir, "/results/enrichr/biomarkerpanel/cdMolecules_Human_Gene_Atlas_table.txt")
rnapc_erwiki_dir = paste0(rnapc_dir, "/results/enrichr/biomarkerpanel/innImmuneGenes_WikiPathways_2016_table.txt")
rnapc_erreact_dir = paste0(rnapc_dir, "/results/enrichr/asthmaExacerbationGenes/Reactome_2016_table.txt")
rnapc_erexach_dir = paste0(rnapc_dir, "/results/enrichr/asthmaExacerbationGenes/LINCS_L1000_Chem_Pert_down_table.txt")
rnapc_erexali_dir = paste0(rnapc_dir, "/results/enrichr/asthmaExacerbationGenes/LINCS_L1000_Ligand_Perturbations_up_table.txt")
...
rnaseq_difbc_dir = paste0(rnaseq_dir, "/results/diff_Exp/BioCarta_2016_table.txt")
rnaseq_difkegg_dir = paste0(rnaseq_dir, "/results/diff_Exp/KEGG_2016_table.txt")
...
# transcriptomics rnaelements nanostring rnaelements_data.Rmd
rnaelements_dir = paste0(root,"/data/RNAelements")
...
hba_attenuation_confirmatory_dirs =
...
hba_attenuation_confirmatory_dir =
...
asthma_discov_dir = paste0(rnaelements_dir, "/data/2015-02-10_Conc_asthmaDiscoveryPlateFeb10.2015.csv")

# cell genes
cell_pc_immune_dir = paste0(root, "/data/Cells_nCounter_Human_PanCancer_Immune_Profiling_Panel_Gene_List.csv")
cell_gene_dir = paste0(result_dir,"/cellgene_dmap.iris.lm22.pc.Rdata")
cell_gene2_dir = paste0(root, "/data/LM22.txt")
cell_type_fig_dir = paste0(rnaelements_dir, "/figs/cellTypes_")

# metab
metab_dir = paste0(data_dir,"/metab")
metab_names_dir = paste0(metab_dir, "/data/metNames.csv")

# object sample demographics meta files
...
meta_filepcdiff_dir = paste0(meta_file_dir,".rnapancancer.setdiff")

grch38_dir = paste0(meta_dir,"/grch38")
meta_col_dir = paste0(meta_dir,"/col-")
meta_col_gt_dir = paste0(meta_dir,"/col-genotype")
meta_col_rnapc_dir = paste0(meta_dir,"/col-rnapcgenes")
meta_col_rnaseq_dir = paste0(meta_dir,"/col-rnaseq")
meta_col_pretty_dir = paste0(meta_dir,"/meta_col_asthma_pretty.csv")
meta_col_rnacells_dir = paste0(meta_col_dir,"-rnaseqstarensgenes_id_cell.Rdata")

feat_dir = paste0(result_dir,"/feat"); dir.create(feat_dir, showWarnings=F)
feat_cell_dir = paste0(feat_dir,"/cell")
feat_genotype_dir = paste0(feat_dir,"/genotype")
...
super_dir = paste0(stat_dir,"/supervised"); dir.create(super_dir, showWarnings=F)
...
metab_hist_dir = paste0(stat_dir, "/hist_metab.pdf")
rnae_5a_dir = paste0(rnaelements_dir, "/results/Figures/Figure5/Figure5a.pdf")
rnae_5b_dir = paste0(rnaelements_dir, "/results/Figures/Figure5/Figure5b.pdf")
rnae_5c_dir = paste0(rnaelements_dir, "/results/Figures/Figure5/Figure5c.pdf")
rnae_5d_dir = paste0(rnaelements_dir, "/results/Figures/Figure5/Figure5d.pdf")

rnaseq_2b_dir = paste0(rnaseq_dir, "/results/Figure2b.pdf")
rnaseq_2c_dir = paste0(rnaseq_dir, "/results/Figures/Figure2/Figure2c.pdf")
rnaseq_2d_dir = paste0(rnaseq_dir, "/results/Figures/Figure2/Figure2d.pdf")
rnaseq_3a_dir = paste0(rnaseq_dir, "/results/Figures/Figure3/Figure3a.pdf")
rnaseq_3c_dir = paste0(rnaseq_dir, "/results/Figures/Figure3/Figure3c.pdf")
rnaseq_3d_dir = paste0(rnaseq_dir, "/results/Figures/Figure3/Figure3d.pdf")
rnaseq_sig_dir = paste0(rnaseq_dir, "/result/significantgenes_DEanalysis.csv")

meta_fev_dir = paste0(rnaelements_dir, "/results/Figure4a_fev.pdf")
meta_rev_dir = paste0(rnaelements_dir, "/results/Figures/Figure4/Figure4b_revised.pdf")
meta_5a_dir = paste0(rnaelements_dir, "/results/Figures/Figure5/Figure5a.pdf")
meta_5b_dir = paste0(rnaelements_dir, "/results/Figures/Figure5/Figure5b.pdf")
meta_5c_dir = paste0(rnaelements_dir, "/results/Figures/Figure5/Figure5c.pdf")
meta_5c_dir = paste0(rnaelements_dir, "/results/Figures/Figure5/Figure5d.pdf")

meta_metab_1a_dir = paste0(metab_dir, "/results/Figure1A.pdf")
meta_metab_1b_dir = paste0(metab_dir, "/results/Figure1B.jpeg")
meta_metab_1c_dir = paste0(metab_dir, "/results/Figure1C.pdf")
meta_metab_1d_dir = paste0(metab_dir, "/results/Figure1D.pdf")
meta_metab_1da_dir = paste0(metab_dir, "/results/Figure1Da.pdf")
meta_metab_1e_dir = paste0(metab_dir, "/results/Figure1E.pdf")
